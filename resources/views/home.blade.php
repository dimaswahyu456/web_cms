    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $jmlh_mcust }}</span></h4>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $jmlh_ftkp }}</span></h4>
                    <p class="text-muted mb-0">Total FTKP</p>
                </div>
            </div>
        </div>
    </div> <!-- end col-->
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ $jmlh_spkh }}</span></h4>
                    <p class="text-muted mb-0">Total Order Produksi</p>
                </div>
            </div>
        </div>
    </div> <!-- end col-->
